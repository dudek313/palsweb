...
module.exports = function testLogin(_browser, _options) {
    ...
    try {
        currentCommand = 'open("/registration", "")';
        browser.get(addBaseUrl("/registration"));

        currentCommand = 'click("link=Login", "")';
        browser.elementByLinkText("Login").click();

        currentCommand = 'type("id=at-field-username_and_email", "gabsun@gmail.com")';
        browser.elementById("at-field-username_and_email").clear();
        browser.elementById("at-field-username_and_email").sendKeys("gabsun@gmail.com");

        currentCommand = 'type("id=at-field-password", "password")';
        browser.elementById("at-field-password").clear();
        browser.elementById("at-field-password").sendKeys("password");

        currentCommand = 'click("id=at-btn", "")';
        browser.elementById("at-btn").click();
