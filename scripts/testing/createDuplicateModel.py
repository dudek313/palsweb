...
class CreateDuplicateModel(unittest.TestCase):
    def setUp(self):
    ...
    def test_create_valid_model(self):
        ...
        driver.find_element_by_name("name").send_keys("something")
        ...
        self.assertEqual("Model Profile: something", driver.find_element_by_css_selector("legend").text)
        driver.find_element_by_link_text("Model Profiles").click()
        driver.find_element_by_link_text("Create Model Profile").click()
        driver.find_element_by_name("name").clear()
        driver.find_element_by_name("name").send_keys("something")
        ...
        driver.find_element_by_name("comments").send_keys("comments")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        self.assertTextPresent("Model name already exists")
